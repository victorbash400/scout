          ...
          <div className="flex items-end gap-2">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 pl-2 mt-1">
                <button type="button" className="text-gray-500 hover:text-green-600 flex items-center justify-center" title="Voice Input">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
                  </svg>
                </button>
                <input type="file" ref={fileInputRef} onChange={handleFileChange} className="hidden" accept=".pdf" />
                <button type="button" onClick={handleAttachClick} className="text-gray-500 hover:text-green-600 flex items-center justify-center" title="Attach File" disabled={isProcessingFile || !!attachedFile}>
                  <Paperclip className="w-5 h-5" />
                </button>
                <div className="relative" ref={dropdownRef}>
                  <button 
                    type="button" 
                    className="text-gray-500 hover:text-green-600 flex items-center justify-center" 
                    title="Mode"
